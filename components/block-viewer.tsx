...
function BlockViewerToolbar() {
  ...
  return (
    <div className="hidden w-full items-center gap-2 md:pr-6 lg:flex">
      <Tabs
        value={view}
...
function BlockViewerCode() {
  ...
  return (
    <div className="bg-code text-muted-foreground! mr-[14px] flex overflow-hidden rounded-xl border group-data-[view=preview]/block-view-wrapper:hidden md:h-(--height)">
      <div className="w-72">
        <BlockViewerFileTree />
      </div>
      <figure
