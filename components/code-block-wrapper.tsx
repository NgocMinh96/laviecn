...
export function CodeBlockWrapper({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute flex items-center justify-center bg-linear-to-b from-zinc-600/30 to-zinc-900/50 p-2",
          open ? "inset-x-0 bottom-0 h-12" : "inset-0",
        )}
      >
        <CollapsibleTrigger asChild>
          <Button className="h-8 bg-background text-foreground hover:bg-background/90">
